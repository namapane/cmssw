...
muonTable = simplePATMuonFlatTableProducer.clone(
    ...
    variables = cms.PSet(CandVars,
        ...
        jetRelIso = Var("?userCand('jetForLepJetVar').isNonnull()?(1./min(userFloat('ptRatio'),1.5))-1.:(pfIsolationR04().sumChargedHadronPt + max(pfIsolationR04().sumNeutralHadronEt + pfIsolationR04().sumPhotonEt - pfIsolationR04().sumPUPt/2,0.0))/pt",float,doc="Relative isolation in matched jet (1/ptRatio-1, pfRelIso04_all if no matched jet)",precision=8),
